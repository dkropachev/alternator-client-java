...
public class AffinityQueryPlanInterceptorTest {
  ...
  @Test
  public void testPutItemSimple_AnyWrite_RecordsAffinityCallback() {
  ...
  @Test
  public void testPutItemSimple_Rmw_RecordsFallbackCallback() {
    RecordingAffinityMetricsCallback callback = new RecordingAffinityMetricsCallback();
    KeyRouteAffinityConfig config =
        KeyRouteAffinityConfig.builder()
  ...
  private static final class RecordingAffinityMetricsCallback implements AffinityMetricsCallback {
    ...
    public void onRoundRobinFallback(
        String tableName, KeyRouteAffinity mode, String reason) {
      roundRobinFallbacks++;
      lastTable = tableName;
