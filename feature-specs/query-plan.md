...
Routing must not change completion, response-handler, publisher, cancellation, duplex, or metrics
semantics.
...
- Calling `next` after base-plan exhaustion follows the iterator contract and invents no candidate.
