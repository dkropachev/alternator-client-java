...
The format, pairings, links, requirement mappings, method-level `@CoversRequirements` evidence, and
structured vectors are checked automatically by `FeatureSpecFormatTest` during the normal test
suite.
